...
# -*- encoding: utf-8 -*-
# stub: resque_safe 0.0.5.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2013-10-04"
  s.description = " Coverts hash and ActiveRecord objects to minimal repersentations for resque to use"
  ...
  s.summary = "Resque Safe conversion for ActiveRecord objects"
